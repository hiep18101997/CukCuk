...
/**
 * - Mục đích Class :Adapter của BillCal - @created_by Hoàng Hiệp on 4/12/2019
 */
public class BillCalculatorAdapter extends RecyclerView.Adapter<BillCalculatorAdapter.ViewHolder> {
  ...
  public BillCalculatorAdapter(Context context, List<Long> suggestMoneys,
      OnClickSuggestMoney onClickSuggestMoney) {
    mContext = context;
  ...
  public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
    holder.tvMoneySuggest
        .setText(NumberFormat.getNumberInstance(Locale.US).format(mSuggestMoneys.get(position)));
