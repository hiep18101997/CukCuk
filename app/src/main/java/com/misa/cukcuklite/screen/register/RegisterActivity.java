...
public class RegisterActivity extends AppCompatActivity implements IRegisterContract.IView,
  ...
  public void onEmptyRePass() {
    Toast.makeText(this, getString(R.string.login_msg_re_password_empty), Toast.LENGTH_SHORT)
        .show();
  }
